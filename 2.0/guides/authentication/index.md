...
- [OIDC Authentication reference](https://pvliesdonk.github.io/paperless-mcp/2.0/deployment/oidc/index.md)
...
- For subpath deployments, see the [subpath deployment guide](https://pvliesdonk.github.io/paperless-mcp/2.0/deployment/oidc/#subpath-deployments); `BASE_URL` must include the prefix, `HTTP_PATH` must not
