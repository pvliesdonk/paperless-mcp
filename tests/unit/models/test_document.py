...
def test_document_note_roundtrip() -> None:
    note = DocumentNote.model_validate({"id": 5, "note": "hi", "created": "2026-04-23T10:00:00Z", "user": 1})
    assert note.id == 5
...
def test_document_history_entry_roundtrip() -> None:
    entry = DocumentHistoryEntry.model_validate({"timestamp": "2026-04-23T10:00:00Z", "action": "modify", "actor": "peter"})
