...
`PAPERLESS_MCP_TASKS_URL` is documented automatically — the config-surface
...
import paperless_mcp.server as server_module
...
_DERIVED_QUEUE_NAME = "paperless-mcp"
"""What pvl-core derives from `PAPERLESS_MCP` — lower-cased, `_` to `-`.
